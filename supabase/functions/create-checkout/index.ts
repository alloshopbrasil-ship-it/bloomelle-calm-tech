...
const PRICE_ALLOWLIST = {
  premium: {
    month: {
      ...
      brl: "price_1TJmdGDIX4T0C71HQaWSuDEK",
    },
    year: {
      eur: "price_1SvNJDDIX4T0C71HW0xfOcIE",
      usd: "price_1SxBvoDIX4T0C71HzbmeUFQd",
      brl: "price_1TJmg8DIX4T0C71HPP7GD8yQ",
    },
  },
} as const;
...
const ALLOWED_PRICE_IDS = new Set<string>([
  ...
  PRICE_ALLOWLIST.premium.month.brl,
  PRICE_ALLOWLIST.premium.year.eur,
  PRICE_ALLOWLIST.premium.year.usd,
  PRICE_ALLOWLIST.premium.year.brl,
]);

const normalizeCurrency = (value: unknown): "eur" | "usd" | "brl" => {
