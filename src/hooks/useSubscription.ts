...
export type SupportedCurrency = 'eur' | 'usd' | 'brl';
...
export const STRIPE_PLANS = {
  premium: {
    month: {
      ...
      brl: {
        product_id: 'prod_UINOiuaMhcofNP',
        price_id: 'price_1TJmdGDIX4T0C71HQaWSuDEK',
        amount: 1990,
      },
    },
    year: {
      ...
      brl: {
        product_id: 'prod_UINQnTEF9KIlyx',
        price_id: 'price_1TJmg8DIX4T0C71HPP7GD8yQ',
        amount: 21500,
      },
    },
  },
...
const inferCurrencyFromLocale = (): SupportedCurrency => {
  ...
  if (locale.includes('pt-br') || locale === 'pt') return 'brl';
