  ...
  const testimonials = [
    {
      name: "Laura",
      role: "29 • França",
      text: t("landing.testimonials.laura"),
    ...
    },
    {
      ...
      image: testimonialTamara,
    },
    {
      name: "Emma",
      role: "31 • Bélgica",
      text: t("landing.testimonials.emma"),
      image: testimonialCarvalho,
    },
    {
      name: "Maria",
      role: "28 • Brasil",
      text: t("landing.testimonials.maria"),
      image: testimonialBorba,
    },
    {
      name: "Clara",
      role: "30 • Itália",
      text: t("landing.testimonials.clara"),
      image: testimonialCourtney,
    },
  ];
